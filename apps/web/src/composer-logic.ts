...
export type ComposerSlashCommand = "model" | "plan" | "default" | "auto";
...
const SLASH_COMMANDS: readonly ComposerSlashCommand[] = ["model", "plan", "default", "auto"];
...
export function parseStandaloneComposerSlashCommand(
  ...
  const match = /^\/(plan|default|auto)\s*$/i.exec(text.trim());
  if (!match) {
    return null;
  }
