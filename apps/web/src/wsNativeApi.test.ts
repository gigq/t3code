...
describe("wsNativeApi", () => {
  ...
  it("forwards project directory browsing to the websocket project method", async () => {
    ...
    expect(requestMock).toHaveBeenCalledWith(WS_METHODS.projectsBrowseDirectories, {
      path: "/tmp",
    });
  });
