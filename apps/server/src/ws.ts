...
import { Cause, Effect, Layer, Option, Path, Queue, Ref, Schema, Stream } from "effect";
import {
  CommandId,
  EventId,
  ...
  Effect.gen(function* () {
    ...
    return WsRpcGroup.of({
      ...
      [WS_METHODS.projectsBrowseDirectories]: (input) =>
        observeRpcEffect(WS_METHODS.projectsBrowseDirectories, browseProjectDirectories(input), {
